...
import stylesDesktop from "./Footer.module.css";
import stylesMobile from "./FooterMobile.module.css";
    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerCol}>
          ...
          <h4 style={{ marginTop: "10px" }}>Dịch vụ giao hàng</h4>
          <img
            className={styles.logo_tikinow}
            src="/assets/images/logo-tikinow.png"
            alt="TikiNow"
          />
        </div>
        ...
        <div className={styles.footerCol}>
          ...
          <h4 style={{ marginTop: "12px" }}>Tải ứng dụng trên điện thoại</h4>
